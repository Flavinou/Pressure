...
VULKAN_SDK_INSTALLER_URL = 'https://sdk.lunarg.com/sdk/download/1.4.341.1/windows/vulkan_sdk.exe'
PRESSURE_VULKAN_VERSION = '1.4.341.1'
VULKAN_SDK_EXE_PATH = 'Pressure/extern/VulkanSDK/VulkanSDK.exe'
...
def CheckVulkanSDK():
    if (VULKAN_SDK is None):
        ...
        InstallVulkanPrompt()
        return False
    elif (PRESSURE_VULKAN_VERSION not in VULKAN_SDK):
        print(f"Located Vulkan SDK at {VULKAN_SDK}")
        print(f"You don't have the correct Vulkan SDK version! (Pressure requires {PRESSURE_VULKAN_VERSION})")
        InstallVulkanPrompt()
        return False
...
VulkanSDKDebugLibsURL = 'https://files.lunarg.com/SDK-1.4.341.1/VulkanSDK-1.4.341.1-DebugLibs.zip'
OutputDirectory = "Pressure/extern/VulkanSDK"
