...
namespace Pressure
{
	...
	namespace
	{
		...
		void DrawComponent(const std::string& label, Entity entity, UIFunction uiFunction)
		{
	...
	{
		// Draw the current scene hierarchy panel
		...
		if (m_Context)
		{
			...
			// Reset selection when blank space is clicked
		...
		// Draw the currently selected entity components
		...
		DrawComponent<SpriteRendererComponent>("Sprite Renderer", entity, [](auto& component) 
		{
			...
			if (ImGui::BeginDragDropTarget())
			{
				if (const ImGuiPayload* payload = ImGui::AcceptDragDropPayload("CONTENT_BROWSER_ITEM"))
				{
					...
					{
						PRS_CORE_WARN("Wrong asset type!");
					}
				}
	...
	void SceneHierarchyPanel::DisplayAddableComponent(const std::string& label)
	{
