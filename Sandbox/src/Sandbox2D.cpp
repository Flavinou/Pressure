...
void Sandbox2D::OnUpdate(Pressure::Timestep ts)
{
...

	{
		...
		Pressure::Renderer2D::DrawQuad({ -5.0f, -5.0f, -0.1f }, { 10.0f, 10.0f }, m_VoronoiTexture, 10.0f);
        Pressure::Renderer2D::DrawQuad({ -0.5f, -0.5f, 0.0f }, { 1.0f, 1.0f }, m_VoronoiTexture, 20.0f);
